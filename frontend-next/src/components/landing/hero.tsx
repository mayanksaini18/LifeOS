...
const modules: FloatingModule[] = [
  {
    ...
    iconBg: "bg-module-mood/15",
    label: "Mood",
    value: "Feeling good",
    cardColor: "bg-module-mood/10 border-module-mood/20",
    style: { top: "4%", left: "2%", animationDelay: "0s", animationDuration: "4.2s" },
  },
  {
    icon: Moon02Icon,
    iconColor: "text-module-sleep",
    iconBg: "bg-module-sleep/15",
    label: "Sleep",
    value: "7.5h last night",
    cardColor: "bg-module-sleep/10 border-module-sleep/20",
    style: { top: "8%", right: "0%", animationDelay: "0.8s", animationDuration: "5s" },
  },
  {
    icon: DropletIcon,
    iconColor: "text-module-water",
    iconBg: "bg-module-water/15",
    label: "Water",
    value: "6 / 8 glasses",
    cardColor: "bg-module-water/10 border-module-water/20",
    style: { bottom: "18%", left: "0%", animationDelay: "1.6s", animationDuration: "4.6s" },
  },
  {
    icon: CheckListIcon,
    iconColor: "text-module-habits",
    iconBg: "bg-module-habits/15",
    label: "Habits",
    value: "3 / 4 done",
    cardColor: "bg-module-habits/10 border-module-habits/20",
    style: { bottom: "8%", right: "2%", animationDelay: "2.4s", animationDuration: "5.4s" },
  },
  {
    icon: Dumbbell01Icon,
    iconColor: "text-module-fitness",
    iconBg: "bg-module-fitness/15",
    label: "Fitness",
    value: "240 kcal",
    cardColor: "bg-module-fitness/10 border-module-fitness/20",
